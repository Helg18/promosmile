...
<form id="form" autocomplete="off" enctype="multipart/form-data"   method="post"  action="{{URL::route('articulosCompraEditar')}}" class="">
 
 <input id="token" type="hidden" name="_token" value="{{{ Session::getToken() }}}">
 <input name="csrf_token" type="hidden" value="{{csrf_token()}}">
 <input name="id" type="hidden" value="{{$cotizacion->id}}">
 <input type="hidden" name="cid" value="{{$ccc->id}}">
      ...
      <div class="col-md-12">
        <fieldset>
         ...
         <div class="form-group col-md-4">
          ...
          <div id="div-placas" class="form-group col-md-4" style="{{($cotizacion->tipoimpresion == 'Tempografia') ? '' : 'display:none;'}}">
            <label class=" control-label" id="" for="">Incluir placas</label>
              <div class="col-md-2">
                @if($cotizacion->placas > 0)
              ...
              <div class="col-md-9" >
                <input type="number" name="placas" style="{{($cotizacion->placas > 0) ? '' : 'visibility:hidden'}}" value="{{$cotizacion->placas}}" max="9" min="0" class="form-control"  id="placas">
              </div>
          </div>
         ...
         <!-- <div class="form-group">
          ...
          <div class="col-md-12">                       
            <div class="form-group">
              ...
              <a class="btn btn-wide btn-warning" href="{{URL::route('cotizacionCompraForm')}}/{{$ccc->id}}" >Regresar</a>
            </div>
          </div>
           </div>
       </div>
