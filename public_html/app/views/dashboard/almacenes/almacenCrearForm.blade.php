...
@section("contenido")
	<form action="{{URL::route('almacenCrear')}}" method="post">
		...
		<div class="col-md-10" >
			<div class="form-group">	
				<input type="submit" class="btn btn-wide btn-success pull-right" value="Guardar">
				<a class="btn btn-wide btn-warning pull-left" href="{{URL::route('almacenLista')}}" >Regresar</a>
			</div>
		</div>
	</form>
@stop
