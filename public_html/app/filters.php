...
Route::filter('prospectos', function()
{
...
Route::filter('vendedores', function()
{
...
Route::filter('proveedores', function()
{
...
Route::filter('cotizacion', function()
{
